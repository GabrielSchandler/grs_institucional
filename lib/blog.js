...
export const CATEGORIAS = {
  "financiamento-de-veiculo": {
    ...
    metaTitle: "Financiamento de Veículo: Artigos e Orientação",
    metaDescription:
  ...
  "financiamento-imobiliario": {
    ...
    metaTitle: "Financiamento Imobiliário: Artigos e Orientação",
    metaDescription:
  ...
  "emprestimo-e-consignado": {
    ...
    metaTitle: "Empréstimo e Consignado: Artigos e Orientação",
    metaDescription:
  ...
  "credito-empresarial": {
    ...
    metaTitle: "Crédito Empresarial: Artigos e Orientação",
    metaDescription:
  ...
  "busca-e-apreensao": {
    ...
    metaTitle: "Busca e Apreensão de Veículo: Artigos e Orientação",
    metaDescription:
  ...
  "golpes-e-praticas-abusivas": {
    ...
    metaTitle: "Golpes Financeiros e Práticas Abusivas",
    metaDescription:
  ...
  "direitos-do-consumidor-bancario": {
    ...
    metaTitle: "Direitos do Consumidor Bancário",
    metaDescription:
  ...
  "educacao-financeira": {
    ...
    metaTitle: "Educação Financeira e Endividamento",
    metaDescription:
