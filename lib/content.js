...
export const CONTATO = {
  telefone: "(11) 96332-2546",
  telefoneE164: "+5511963322546",
  telefoneFixo: "(11) 2941-6796",
  telefoneFixoE164: "+551129416796",
  whatsappUrl:
    "https://wa.me/5511963322546?text=" +
  ...
  // Segundo domínio da própria GRS: é onde fica o formulário de atendimento
  // que alimenta o comercial. Precisa estar declarado como mesma entidade
  // (sameAs + llms.txt), senão buscador e IA tratam os dois domínios como
  // empresas diferentes — e o conteúdo daqui não sustenta a recomendação de lá.
  landingUrl: "https://grsrevisional.com.br",
};
...
export const FAQ = [
  {
    ...
    resposta:
      "A expressão designa a cobrança de juros e encargos em desacordo com o que foi contratado ou com as normas aplicáveis. Um ponto merece cuidado: taxa acima da média divulgada pelo Banco Central não configura, por si só, abusividade. O Superior Tribunal de Justiça afastou a comparação isolada com a média como fundamento suficiente, e o critério definitivo está submetido ao Tema Repetitivo 1.378, ainda sem tese fixada até agosto de 2026. A média é um parâmetro de comparação, e não um veredito — cada contrato precisa ser avaliado individualmente.",
  },
  {
    pergunta: "Como saber se estou pagando juros abusivos?",
    resposta:
      "Alguns sinais indicam que vale investigar: saldo devedor que não cede ao longo do tempo, divergência entre o custo efetivo total informado e a taxa anunciada, encargos que não constam do contrato e valor financiado maior do que o efetivamente liberado. Nenhum deles, isoladamente, comprova irregularidade — são indícios de que o contrato merece exame. A verificação exige análise técnica do documento e da evolução da dívida.",
  },
  {
  ...
  },
  {
    ...
    resposta:
      "Existe essa possibilidade por medida judicial, como a tutela antecipada, mas ela depende de decisão do juízo e dos elementos do caso concreto — não é consequência automática de ajuizar uma ação. Eventuais medidas judiciais são conduzidas por advogados parceiros habilitados, e cada situação é avaliada individualmente.",
  },
];
