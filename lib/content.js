...
export const PAGINAS_SERVICO = {
  ...
  "revisao-emprestimo": {
    ...
    metaTitle: "Revisão de Empréstimo Pessoal e Cheque Especial | GRS Soluções",
    metaDescription:
  ...
  "revisao-credito-empresarial": {
    ...
    intro:
      "Crédito para pessoa jurídica costuma vir com estrutura mais complexa que o crédito para pessoa física — garantias, taxas variáveis, tarifas de estruturação e cláusulas de renovação automática. Quando o porte da empresa não é levado em conta na negociação, é comum que o custo efetivo total fique bem acima do que uma operação equivalente deveria ter.",
    sinais: [
      {
    ...
    testemunhos: [DEPOIMENTO_POR_NOME("Carla Mendes")],
    faq: [
      {
