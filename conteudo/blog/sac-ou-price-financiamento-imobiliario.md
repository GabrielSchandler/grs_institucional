---
titulo: "SAC ou Price no financiamento imobiliário: a diferença real e por que a Tabela Price não é ilegal"
slug: sac-ou-price-financiamento-imobiliario
...
metaDescription: "Como cada sistema de amortização funciona, qual pesa mais no bolso e por que o STJ entende que a Tabela Price não configura, por si só, juros sobre juros."

resumo: "SAC e Tabela Price distribuem o pagamento de formas diferentes: um começa com parcela alta que cai, o outro com parcela fixa. Nenhum dos dois é irregular. Este guia explica a diferença real, desmonta a ideia de que a Price seria 'juros sobre juros' — posição que o STJ não sustenta — e mostra o que de fato merece atenção num contrato longo."

respostaRapida: "No SAC (Sistema de Amortização Constante), a parcela de amortização é sempre a mesma e os juros incidem sobre um saldo que cai de forma linear: as primeiras prestações são mais altas e vão diminuindo. Na Tabela Price, a prestação é fixa do início ao fim, mas sua composição muda — no começo predominam os juros e ao final a amortização. Nenhum dos dois é ilegal. O STJ tem posição firme de que a simples adoção da Tabela Price não implica, por si só, capitalização de juros; e o Tema Repetitivo 572 registra que verificar se houve capitalização indevida é questão de fato, dependente do exame do contrato e das planilhas, e não questão de direito. Capitalização em periodicidade inferior à anual exige previsão contratual expressa."
...
keywords:
  ...
  - amortização financiamento imobiliário
  - juros sobre juros tabela price
  - anatocismo tabela price
...
imagem: /img/blog/sac-ou-price-financiamento-imobiliario/capa.webp
imagemAlt: "Planta de imóvel e documento sobre mesa escura, iluminados por uma faixa estreita de luz vermelha"
...
faq:
  - pergunta: "A Tabela Price é ilegal?"
    resposta: "Não. O STJ tem jurisprudência consolidada de que a mera utilização da Tabela Price como sistema de amortização não implica, por si só, capitalização de juros. O Tema Repetitivo 572 registra que apurar se houve capitalização indevida em um contrato específico é questão de fato, que depende do exame do contrato e das planilhas — e por isso não é revista pelo STJ, em razão das Súmulas 5 e 7."
  - pergunta: "Então a Price nunca pode ser questionada?"
    resposta: "O que não se sustenta é a alegação genérica de que a Price seria ilegal por natureza. O que pode ser questionado é outra coisa: se o contrato prevê expressamente a capitalização em periodicidade inferior à anual, e se a planilha executada corresponde ao sistema pactuado. São verificações concretas sobre aquele contrato, não teses abstratas sobre o sistema."
  - pergunta: "Qual dos dois é mais barato no total?"
    resposta: "Mantidos prazo, valor e taxa idênticos, o SAC costuma resultar em menor total de juros pagos, porque o saldo devedor cai mais rápido no início e os juros incidem sobre um valor menor ao longo do contrato. A contrapartida é que as primeiras parcelas são mais altas — o que também significa exigência maior de renda na aprovação."
  - pergunta: "Por que minha parcela na Price parece não abater nada no começo?"
    resposta: "Porque no início a maior parte da prestação é juros e apenas uma fração pequena amortiza o saldo. Com o tempo essa proporção se inverte. É característica do sistema, e não indício de irregularidade — motivo pelo qual essa sensação, sozinha, não serve de base para conclusão sobre o contrato."
  - pergunta: "Posso trocar de Price para SAC no meio do contrato?"
    resposta: "O sistema de amortização é condição do contrato e sua alteração depende de acordo com a instituição financeira, não sendo um direito automático do contratante. Em alguns casos a portabilidade para outra instituição, com condições diferentes, acaba sendo o caminho mais viável."
  - pergunta: "No SAC as parcelas sempre caem?"
  ...
  - pergunta: "O que é capitalização de juros e quando ela é permitida?"
    resposta: "É a incidência de juros sobre juros já incorporados ao saldo. Em periodicidade inferior à anual, ela depende de previsão contratual expressa. Quando o contrato é silente e a execução revela incidência composta, existe divergência entre o pactuado e o praticado — e esse é um ponto objetivamente verificável na memória de cálculo."
  - pergunta: "A correção monetária pelo índice do contrato pode ser questionada?"
    resposta: "O que se examina não é a existência de correção, que é normal em contratos longos, e sim se o índice aplicado é o previsto no contrato e se foi aplicado na periodicidade correta. Divergência entre o índice pactuado e o praticado é questão concreta, verificável documentalmente."
  - pergunta: "Em contrato de 30 anos, quanto pesa a escolha do sistema?"
    resposta: "Bastante, justamente pelo prazo. Em contratos longos, diferenças pequenas na forma como os juros incidem se multiplicam ao longo de centenas de prestações. É por isso que, em financiamento imobiliário, a conferência da planilha de amortização costuma pesar mais do que a comparação isolada da taxa com a média de mercado."
  - pergunta: "Existe um sistema 'certo' para escolher?"
    resposta: "Não em abstrato. O SAC reduz o total pago e exige mais no começo; a Price alivia o início e custa mais no total. A escolha depende da capacidade de pagamento no momento da contratação e do horizonte de permanência com o contrato — quem pretende quitar ou vender antes do fim tem cálculo diferente de quem vai até a última parcela."

fontes:
  - titulo: "STJ — Tema Repetitivo 572: legalidade da Tabela Price e verificação de capitalização como questão de fato"
    url: "https://processo.stj.jus.br/repetitivos/temas_repetitivos/pesquisa.jsp?novaConsulta=true&tipo_pesquisa=T&cod_tema_inicial=572&cod_tema_final=572"
    consultadoEm: 2026-08-05
  - titulo: "TJDFT — Jurisprudência em temas: Tabela Price, legalidade"
    url: "https://www.tjdft.jus.br/consultas/jurisprudencia/jurisprudencia-em-temas/jurisprudencia-em-detalhes/acao-revisional-de-contrato-bancario/tabela-price-legalidade"
    consultadoEm: 2026-08-05
  - titulo: "STJ — Previsão contratual é exigida para capitalização de juros em qualquer periodicidade"
    url: "https://www.stj.jus.br/sites/portalp/Paginas/Comunicacao/Noticias-antigas/2017/2017-02-09_18-51_Previsao-contratual-e-exigida-para-capitalizacao-de-juros-em-qualquer-periodicidade.aspx"
    consultadoEm: 2026-08-05
...
<aside class="callout">
<p><strong>A consequência prática da diferença.</strong> Como no SAC o saldo devedor cai mais rápido desde a primeira parcela, os juros passam a incidir sobre valores menores mais cedo. Mantidos prazo, valor e taxa idênticos, isso costuma resultar em <strong>menor total de juros pagos</strong> — ao custo de exigir mais no início, inclusive na comprovação de renda para aprovação.</p>
</aside>
...
<aside class="callout">
<p><strong>Por que essa distinção importa para quem contrata um serviço.</strong> Quem promete revisão baseada em "a Tabela Price é ilegal" está oferecendo uma tese que os tribunais não acolhem. A pergunta certa não é qual sistema o contrato usa — é se o que a planilha executou corresponde ao que o contrato prevê.</p>
</aside>
...
E quem promete revisão com base em "a Tabela Price é ilegal" está vendendo uma tese que os tribunais não acolhem — assunto tratado em [como reconhecer promessa irreal no mercado de revisão](/blog/promessa-irreal-mercado-revisao-dividas/).
