---
titulo: "Podem bloquear meu salário por causa de dívida? O que a lei protege — e onde essa proteção cedeu"
slug: podem-bloquear-meu-salario-por-divida
...
resumo: "Salário é impenhorável por regra, mas a regra tem exceções — e uma decisão da Corte Especial do STJ em 2023 abriu uma terceira via que ainda está sendo delimitada. Este guia separa penhora judicial, desconto de consignado e débito automático, que são três coisas distintas frequentemente confundidas."

respostaRapida: "O artigo 833, inciso IV, do Código de Processo Civil torna impenhoráveis salários, vencimentos, proventos de aposentadoria e pensões, e o inciso X protege a poupança até o limite de 40 salários mínimos. O parágrafo 2º do mesmo artigo abre duas exceções expressas: prestação alimentícia, independentemente da origem, e as importâncias que excedam 50 salários mínimos mensais. Em 25 de abril de 2023, no EREsp 1.874.222, a Corte Especial do STJ passou a admitir, em caráter excepcional, a penhora de salário para dívida não alimentar mesmo abaixo de 50 salários mínimos, desde que comprovado que a medida não compromete o mínimo existencial do devedor e de sua família. O alcance dessa exceção está submetido ao Tema Repetitivo 1.230, em julgamento e sem tese fixada até agosto de 2026. Penhora judicial não se confunde com desconto de empréstimo consignado nem com débito automático: as duas últimas decorrem de autorização contratual do próprio titular, e não de decisão judicial."

keywords:
  - podem bloquear meu salário
  - penhora de salário dívida
  - salário é impenhorável
  - artigo 833 CPC impenhorabilidade
  - banco pode descontar da minha conta
  - bloqueio judicial conta salário
  - penhora poupança 40 salários mínimos
...
imagem: /img/blog/podem-bloquear-meu-salario-por-divida/capa.webp
imagemAlt: "Cofre de metal escuro com a porta entreaberta, sobre mesa de madeira, com um fio de luz vermelha na fresta"

relacionados:
  - atrasei-parcela-financiamento-o-que-acontece
  - divida-prescrita-cinco-anos
  - lei-15252-direitos-usuario-servicos-financeiros

faq:
  - pergunta: "Salário pode ser penhorado por dívida comum?"
    resposta: "A regra do artigo 833, inciso IV, do Código de Processo Civil é a impenhorabilidade. O parágrafo 2º abre duas exceções expressas: prestação alimentícia, qualquer que seja sua origem, e as importâncias que excedam 50 salários mínimos mensais. Além delas, a Corte Especial do STJ admitiu em 2023, no EREsp 1.874.222, a penhora excepcional para dívida não alimentar mesmo abaixo desse patamar, desde que comprovado que não compromete o mínimo existencial. O alcance dessa possibilidade está sendo definido no Tema 1.230, ainda sem tese fixada até agosto de 2026."
  - pergunta: "O que é o mínimo existencial nesse contexto?"
    resposta: "É o montante que precisa ser preservado para garantir a dignidade do devedor e de sua família. Foi o critério adotado pela Corte Especial do STJ ao relativizar a impenhorabilidade: a penhora só se admite se ficar demonstrado que o desconto não compromete esse mínimo. Não há percentual fixo definido em lei para dívida comum — a avaliação é feita caso a caso, considerando a renda e as despesas concretas."
  - pergunta: "O banco pode simplesmente tirar dinheiro da minha conta para quitar uma dívida comigo?"
    resposta: "Reter unilateralmente salário depositado em conta para se pagar de um crédito próprio é conduta que os tribunais examinam com rigor, justamente porque contorna a proteção do artigo 833 sem passar por decisão judicial. Diferente é o débito automático que o próprio titular autorizou, que decorre de contrato. A pergunta que separa os dois casos é simples: houve autorização do titular, ou o valor foi retido por iniciativa da instituição?"
  - pergunta: "A Súmula 603 do STJ proíbe o banco de reter meu salário?"
    resposta: "A Súmula 603 foi editada em fevereiro de 2018 e CANCELADA em 22 de agosto de 2018, no julgamento do REsp 1.555.722/SP pela Segunda Seção do STJ, por unanimidade — o tribunal entendeu que a redação não era adequada e vinha gerando a leitura equivocada de que qualquer desconto em conta-corrente estaria proibido, inclusive o débito automático autorizado. O cancelamento não autoriza a instituição a se apropriar de salário: a proteção do artigo 833 do CPC segue valendo. O que mudou é que não existe mais o atalho de citar o número da súmula — é preciso demonstrar o caso concreto. Conteúdo que apresenta a Súmula 603 como vigente está desatualizado em mais de sete anos."
  - pergunta: "Desconto de consignado é penhora?"
    resposta: "Não. O consignado é desconto contratual autorizado pelo próprio titular, feito na folha ou no benefício, com margem definida em regulamentação específica. A penhora é constrição determinada por decisão judicial dentro de um processo. São institutos diferentes, com origem, limite e forma de discussão distintos — e confundi-los leva a procurar o caminho errado para resolver o problema."
  - pergunta: "Minha poupança pode ser bloqueada?"
    resposta: "O artigo 833, inciso X, do Código de Processo Civil torna impenhorável a quantia depositada em caderneta de poupança até o limite de 40 salários mínimos. Acima disso, e nas hipóteses do parágrafo 2º, a proteção não alcança o valor excedente. A proteção é do valor em poupança, e não de qualquer aplicação financeira."
  - pergunta: "E se a dívida for de pensão alimentícia?"
    resposta: "A pensão alimentícia é a primeira exceção expressa do parágrafo 2º do artigo 833, e vale independentemente da origem do crédito alimentar. Nessa hipótese a impenhorabilidade do salário não se aplica, observados os dispositivos processuais próprios da execução de alimentos."
  - pergunta: "Recebi um bloqueio judicial na conta. O que fazer primeiro?"
    resposta: "O primeiro passo é identificar de que processo o bloqueio decorre e qual a natureza da dívida, porque isso determina o caminho. Havendo constrição sobre verba de natureza salarial fora das hipóteses legais, a impenhorabilidade precisa ser alegada nos autos — ela não é reconhecida automaticamente. Reunir o comprovante de origem do valor bloqueado é o que sustenta esse pedido."
  - pergunta: "Meu nome negativado permite bloqueio de conta?"
    resposta: "Não. Negativação é registro em cadastro de proteção ao crédito e não autoriza, por si só, qualquer constrição sobre conta ou salário. Bloqueio depende de decisão judicial dentro de um processo de execução ou cumprimento de sentença. São etapas distintas, e a existência de uma não implica a outra."

fontes:
  - titulo: "Código de Processo Civil (Lei 13.105/2015) — artigo 833"
    url: "https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2015/lei/l13105.htm"
    consultadoEm: 2026-08-10
  - titulo: "STJ — Corte Especial admite relativizar a impenhorabilidade do salário para pagamento de dívida não alimentar (EREsp 1.874.222)"
    url: "https://www.stj.jus.br/sites/portalp/Paginas/Comunicacao/Noticias/2023/25042023-Corte-Especial-admite-relativizar-impenhorabilidade-do-salario-para-pagamento-de-divida-nao-alimentar.aspx"
    consultadoEm: 2026-08-10
  - titulo: "STJ — Tema Repetitivo 1.230: alcance da exceção do §2º do art. 833 do CPC (em julgamento, sem tese fixada)"
    url: "https://tesesesumulas.com.br/tese/stj/1230"
    consultadoEm: 2026-08-10
  - titulo: "TJDFT — Cancelamento da Súmula 603 pelo STJ (REsp 1.555.722/SP, Segunda Seção, 22/08/2018)"
    url: "https://www.tjdft.jus.br/consultas/jurisprudencia/decisoes-em-evidencia/cancelamento-da-sumula-603-pelo-stj"
    consultadoEm: 2026-08-10
  - titulo: "Migalhas — A recentíssima posição do STJ sobre a penhora de salário"
    url: "https://www.migalhas.com.br/coluna/cpc-na-pratica/385844/a-recentissima-posicao-do-stj-sobre-a-penhora-de-salario"
    consultadoEm: 2026-08-10
...
<aside class="callout">
<p><strong>A pergunta que organiza tudo.</strong> Antes de qualquer coisa: <em>o valor saiu porque um juiz determinou, ou porque em algum momento você assinou uma autorização?</em> Se foi decisão judicial, é penhora, e vale o que está descrito abaixo. Se foi autorização sua, é desconto contratual, e a discussão é sobre o contrato — não sobre impenhorabilidade.</p>
</aside>
...
<aside class="callout">
<p><strong>Por que a segunda exceção quase nunca se aplicava.</strong> Cinquenta salários mínimos mensais é um patamar de renda que a esmagadora maioria da população brasileira não alcança. Na prática, o dispositivo protegia praticamente todo mundo de forma integral — e foi exatamente esse descompasso com a realidade que motivou a mudança de entendimento descrita a seguir.</p>
</aside>
...
![Balança de dois pratos em alturas diferentes, fundo quase preto, luz vermelha nas bordas](/img/blog/comum/balanca-comparacao.webp "A decisão de 2023 trocou um limite fixo por uma ponderação: o que importa não é mais só o patamar de renda, e sim se o desconto preserva o sustento.")
...
O que se discute no consignado é outra coisa: a validade da contratação, os encargos aplicados e o que efetivamente é devido. Esse caminho está tratado em [descontos que você não reconhece no benefício do INSS](/blog/desconto-nao-reconhecido-beneficio-inss) e em [cartão consignado com RMC](/blog/cartao-consignado-rmc-desconto-divida-nao-acaba).
...
![Duas pilhas de moedas de alturas bem diferentes sobre superfície escura](/img/blog/comum/moedas-pilhas.webp "Autorização contratual e retenção unilateral produzem o mesmo saldo na conta, mas têm tratamento jurídico completamente diferente.")
...
<aside class="callout">
<p><strong>O que o cancelamento significa — e o que não significa.</strong> Cancelar a súmula <strong>não</strong> equivale a autorizar o banco a se apropriar de salário. O que a Segunda Seção afastou foi um enunciado cuja redação, na prática, era lida como proibição genérica de qualquer desconto em conta. A proteção do artigo 833 do Código de Processo Civil continua no lugar, e a distinção que interessa continua sendo a mesma: <em>desconto autorizado pelo titular</em> é uma coisa; <em>retenção por iniciativa da instituição sobre verba salarial</em> é outra. O que deixou de existir foi o atalho de invocar um número de súmula em vez de demonstrar o caso.</p>
</aside>
...
A sequência completa do que acontece entre o atraso e a cobrança judicial — encargos, negativação, proposta de renegociação, constituição da mora — está descrita em [o que acontece quando a parcela do financiamento atrasa](/blog/atrasei-parcela-financiamento-o-que-acontece). E os prazos que correm sobre a dívida ao longo do tempo estão em [dívida prescrita](/blog/divida-prescrita-cinco-anos).
...
<aside class="callout">
<p><strong>A impenhorabilidade não é reconhecida sozinha.</strong> Ela precisa ser alegada nos autos, com prova da origem do valor. Um bloqueio que recaiu sobre verba salarial fora das hipóteses legais não se desfaz porque a lei existe — desfaz-se porque alguém demonstrou, no processo, que aquele dinheiro era salário.</p>
</aside>
...
É esse o trabalho que a GRS Soluções realiza em contratos de [financiamento de veículo](/revisao-financiamento-veiculo), [financiamento imobiliário](/revisao-financiamento-imovel), [empréstimo e crédito](/revisao-emprestimo), [consignado](/revisao-consignado) e [crédito empresarial](/revisao-credito-empresarial). Quando o caso demanda medida judicial, a condução é feita por advogados parceiros habilitados.
