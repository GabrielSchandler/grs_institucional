---
titulo: "Tarifas no financiamento de veículo: o que pode ser cobrado, o que não pode — e as datas de corte que decidem"
slug: tarifas-financiamento-veiculo-o-que-pode-ser-cobrado
...
metaTitle: "Tarifas no Financiamento de Veículo: o Que Pode Cobrar"
metaDescription: "TAC, serviços de terceiros, registro e avaliação do bem. O que o Tema 958 e a Súmula 565 do STJ definiram — e as datas que decidem cada cobrança."
...
respostaRapida: "Nem toda tarifa em contrato de financiamento de veículo é indevida, e nem toda cobrança é válida — o critério depende de qual tarifa e de quando o contrato foi assinado. Pela Súmula 565 do Superior Tribunal de Justiça, aprovada em 24 de fevereiro de 2016, a pactuação da Tarifa de Abertura de Crédito (TAC) e da Tarifa de Emissão de Carnê (TEC), ou de outra denominação para o mesmo fato gerador, é válida apenas nos contratos bancários anteriores ao início da vigência da Resolução CMN 3.518/2007, em 30 de abril de 2008. No Tema 958, julgado no REsp 1.578.553/SP pela Segunda Seção em 28 de novembro de 2018, sob relatoria do ministro Paulo de Tarso Sanseverino, o STJ fixou três teses: é abusiva a cláusula que prevê ressarcimento de serviços prestados por terceiros sem a especificação do serviço a ser efetivamente prestado; é abusivo o ressarcimento de comissão de correspondente bancário em contratos celebrados a partir de 25 de fevereiro de 2011, data de vigência da Resolução CMN 3.954/2011, sendo válida a cláusula em contratos anteriores, ressalvado o controle de onerosidade excessiva; e são válidas a tarifa de avaliação do bem dado em garantia e a cláusula de ressarcimento de despesa com o registro do contrato, ressalvadas a abusividade da cobrança por serviço não efetivamente prestado e a possibilidade de controle da onerosidade excessiva em cada caso concreto."

keywords:
  - tarifas financiamento de veículo
  - tarifa de cadastro é legal
  - Tema 958 STJ tarifas
  - serviços de terceiros financiamento
  - tarifa de gravame registro de contrato
  - Súmula 565 STJ TAC TEC
...
imagem: /img/blog/tarifas-financiamento-veiculo-o-que-pode-ser-cobrado/capa.webp
imagemAlt: "Fileira de pesos de balança de latão de tamanhos diferentes alinhados sobre mesa de madeira escura, com luz vermelha rasante"

relacionados:
  - cet-custo-efetivo-total-o-que-e
  - seguro-prestamista-financiamento-cobertura-recusa
  - quitacao-antecipada-financiamento-desconto-juros

faq:
  - pergunta: "Toda tarifa cobrada no financiamento é indevida?"
    resposta: "Não, e essa é a leitura mais importante deste tema. O STJ examinou as tarifas mais comuns em julgamentos repetitivos e concluiu de formas diferentes conforme a tarifa. No Tema 958, considerou válidas a tarifa de avaliação do bem dado em garantia e a cláusula de ressarcimento da despesa de registro do contrato, ressalvadas a cobrança por serviço não efetivamente prestado e o controle de onerosidade excessiva. Conteúdo que afirma que toda tarifa é abusiva descreve algo que os tribunais não decidiram."
  - pergunta: "A tarifa de cadastro pode ser cobrada?"
    resposta: "Depende da data do contrato. A Súmula 565 do STJ estabelece que a pactuação da Tarifa de Abertura de Crédito (TAC) e da Tarifa de Emissão de Carnê (TEC), ou de outra denominação para o mesmo fato gerador, é válida apenas nos contratos bancários anteriores ao início da vigência da Resolução CMN 3.518/2007, em 30 de abril de 2008. A partir dessa data, a cobrança de serviços bancários prioritários a pessoas físicas passou a ficar limitada às hipóteses previstas na regulamentação, e deixou de haver respaldo para essas tarifas."
  - pergunta: "O que o Tema 958 do STJ decidiu?"
    resposta: "Foi julgado no REsp 1.578.553/SP pela Segunda Seção em 28 de novembro de 2018, sob relatoria do ministro Paulo de Tarso Sanseverino, e fixou três teses. Primeira: é abusiva a cláusula que prevê ressarcimento de serviços prestados por terceiros sem a especificação do serviço a ser efetivamente prestado. Segunda: é abusivo o ressarcimento de comissão de correspondente bancário em contratos celebrados a partir de 25 de fevereiro de 2011, data de vigência da Resolução CMN 3.954/2011, sendo válida a previsão em contratos anteriores, ressalvado o controle de onerosidade excessiva. Terceira: são válidas a tarifa de avaliação do bem dado em garantia e a cláusula que prevê ressarcimento de despesa com o registro do contrato, ressalvadas a abusividade por serviço não efetivamente prestado e a possibilidade de controle da onerosidade excessiva."
  - pergunta: "O que significa 'serviços de terceiros sem especificação'?"
    resposta: "É a cláusula que prevê o ressarcimento de um valor a título de serviços prestados por terceiros sem dizer que serviço é esse. O problema apontado pelo STJ não é a existência de serviço de terceiro na operação — é a ausência de especificação, que impede o contratante de saber o que está pagando e de verificar se o serviço foi de fato prestado. É por isso que a tese fala em abusividade da cláusula genérica, e não da modalidade em si."
  - pergunta: "A tarifa de registro do contrato e o gravame podem ser cobrados?"
    resposta: "A terceira tese do Tema 958 reconheceu a validade da cláusula que prevê ressarcimento da despesa com o registro do contrato, com duas ressalvas expressas: não pode haver cobrança por serviço não efetivamente prestado, e permanece possível o controle da onerosidade excessiva em cada caso concreto. Ou seja, a cobrança em si tem respaldo; o que se examina é se o serviço existiu e se o valor é proporcional."
  - pergunta: "E a tarifa de avaliação do bem?"
    resposta: "Também foi considerada válida na terceira tese do Tema 958, com as mesmas ressalvas: abusividade quando o serviço não é efetivamente prestado e possibilidade de controle da onerosidade excessiva. Na prática, isso desloca a discussão de 'a tarifa é legal?' para 'a avaliação foi realizada?' — pergunta que se responde com documentos."
  - pergunta: "O que é comissão de correspondente bancário?"
    resposta: "Correspondente bancário é a empresa que intermedia a contratação em nome da instituição financeira — a concessionária ou a loja onde o financiamento foi fechado, por exemplo. A comissão é a remuneração dessa intermediação. Pelo Tema 958, repassá-la ao consumidor é abusivo em contratos celebrados a partir de 25 de fevereiro de 2011, data de vigência da Resolução CMN 3.954/2011. Em contratos anteriores, a cláusula é válida, ressalvado o controle de onerosidade excessiva."
  - pergunta: "Por que a data do contrato importa tanto?"
    resposta: "Porque em ambos os julgamentos o STJ fixou a validade a partir de marcos regulatórios: 30 de abril de 2008 para TAC e TEC, e 25 de fevereiro de 2011 para a comissão de correspondente. Contratos anteriores a essas datas seguem o regime anterior. É por isso que a primeira informação relevante sobre uma tarifa não é o nome dela, e sim a data em que o contrato foi assinado."
  - pergunta: "Como as tarifas afetam o custo do financiamento?"
    resposta: "Elas integram o Custo Efetivo Total, e quando são financiadas junto com o principal deixam de ser apenas um valor cobrado: passam a render juros ao longo de todo o contrato. É a razão mais comum para a distância entre a taxa de juros anunciada e o custo real da operação — assunto tratado no artigo sobre o CET."
  - pergunta: "Encontrei uma tarifa que não reconheço. Isso comprova irregularidade?"
    resposta: "Não por si só. A existência de uma tarifa no contrato não significa que ela seja indevida, e a ausência de lembrança do contratante não é critério jurídico. O que se examina é qual é a tarifa, o que o contrato diz sobre ela, quando o contrato foi assinado e se o serviço correspondente foi prestado. São quatro perguntas que dependem dos documentos, e não do nome que aparece na linha."

fontes:
  - titulo: "STJ — Súmula 565: pactuação da TAC e da TEC válida apenas em contratos anteriores a 30/4/2008 (Resolução CMN 3.518/2007)"
    url: "https://scon.stj.jus.br/SCON/sumstj/doc.jsp?livre=%22565%22.num.&b=SUMU"
    consultadoEm: 2026-08-22
  - titulo: "STJ — Aprovada nova súmula que trata da tarifa de contrato bancário (Súmula 565, Segunda Seção, 24/02/2016)"
    url: "https://www.stj.jus.br/sites/portalp/Paginas/Comunicacao/Noticias-antigas/2016/2016-03-02_16-11_Aprovada-nova-sumula-que-trata-da-tarifa-de-contrato-bancario.aspx"
    consultadoEm: 2026-08-22
  - titulo: "TJDFT — Tarifa de serviços de terceiros e as teses do Tema 958 do STJ (REsp 1.578.553/SP)"
    url: "https://www.tjdft.jus.br/consultas/jurisprudencia/jurisprudencia-em-temas/jurisprudencia-em-detalhes/acao-revisional-de-contrato-bancario/ilegalidade-da-tarifa-de-servicos-de-terceiros"
    consultadoEm: 2026-08-22
  - titulo: "TJDFT — Tarifa de registro de contrato e inclusão de gravame: legalidade"
    url: "https://www.tjdft.jus.br/consultas/jurisprudencia/jurisprudencia-em-temas/jurisprudencia-em-detalhes/acao-revisional-de-contrato-bancario/ilegalidade-de-cobranca-de-tarifa-de-registro-de-contrato"
    consultadoEm: 2026-08-22
  - titulo: "TJDFT — Tarifa de Abertura de Crédito (TAC) e Tarifa de Emissão de Carnê (TEC)"
    url: "https://www.tjdft.jus.br/consultas/jurisprudencia/jurisprudencia-em-temas/jurisprudencia-em-detalhes/acao-revisional-de-contrato-bancario/tarifa-de-abertura-de-credito-tac-e-tarifa-de-emissao-de-carne-tec"
    consultadoEm: 2026-08-22
  - titulo: "Código de Defesa do Consumidor (Lei 8.078/1990) — artigo 52, dever de informação prévia no fornecimento de crédito"
...
<aside class="callout">
<p><strong>O que este artigo faz.</strong> Reúne o que o STJ fixou em julgamento repetitivo sobre as tarifas mais comuns em financiamento de veículo, com as datas de corte que decidem cada uma. Não é um roteiro para auditar o próprio contrato — é o mapa do que está definido e do que continua dependendo do caso concreto.</p>
</aside>
...
<aside class="callout">
<p><strong>Uma observação sobre "tarifa de cadastro".</strong> A expressão aparece em contratos de épocas diferentes e nem sempre designa a mesma coisa. O que a Súmula 565 alcança é a cobrança cujo fato gerador corresponde ao da TAC ou da TEC — independentemente do nome usado. Identificar isso exige olhar o que a cláusula descreve, e não apenas a palavra que a encabeça.</p>
</aside>
...
<aside class="callout">
<p><strong>O deslocamento que a Tese 3 produz.</strong> A pergunta deixa de ser <em>"essa tarifa é legal?"</em> — a resposta é sim — e passa a ser <em>"o serviço foi efetivamente prestado, e o valor é proporcional?"</em>. São perguntas que se respondem com documentos, e não com jurisprudência.</p>
</aside>
...
![Balança de dois pratos em alturas diferentes, fundo quase preto](/img/blog/comum/balanca-comparacao.webp "O STJ não declarou as tarifas abusivas em bloco. Decidiu caso a caso, e em duas delas o critério é a data do contrato.")
...
<aside class="callout">
<p><strong>A consequência prática.</strong> Antes de perguntar se uma tarifa é devida, é preciso saber <strong>quando o contrato foi assinado</strong>. Sem essa data, qualquer conclusão sobre TAC, TEC ou comissão de correspondente é chute — e conteúdo que responde sem perguntar isso está simplificando o que os tribunais decidiram com cuidado.</p>
</aside>
...
![Lupa de aro escuro sobre folha em branco, mesa de madeira](/img/blog/comum/lupa-analise.webp "A lista de tarifas está no contrato. Se cada uma tem respaldo no regime da data em que ele foi assinado é outra pergunta.")
...
<aside class="callout">
<p><strong>O teste.</strong> Quando um texto afirma que determinada cobrança é sempre indevida, vale procurar a data de corte e as ressalvas. Nos dois julgamentos tratados aqui, elas existem e são explícitas — e é justamente nelas que a maior parte dos casos concretos se resolve.</p>
</aside>
...
A GRS Soluções analisa contratos de financiamento e apura o que foi efetivamente cobrado frente ao que foi contratado, considerando o regime aplicável à data de cada contrato. A página de [revisão de financiamento de veículo](/revisao-financiamento-veiculo) descreve como esse exame é conduzido.
