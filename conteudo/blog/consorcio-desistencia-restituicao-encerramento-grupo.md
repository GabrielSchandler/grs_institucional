---
titulo: "Desisti do consórcio: quando o dinheiro volta, quanto volta — e por que não é na hora"
slug: consorcio-desistencia-restituicao-encerramento-grupo
...
metaTitle: "Desisti do Consórcio: Quando e Quanto o Dinheiro Volta"
metaDescription: "A restituição ao consorciado desistente não é imediata nem pelo valor nominal pago. O que diz a Lei 11.795/2008, o Tema 312 do STJ e o que se discute."

resumo: "Quem desiste de um consórcio quase sempre espera receber de volta o que pagou, e receber logo. As duas expectativas colidem com a lei. A restituição depende do encerramento do grupo e é calculada sobre o percentual amortizado do valor do bem, não sobre a soma das parcelas. Este guia explica o mecanismo, os prazos legais e os dois pontos que mais geram discussão: a taxa de administração e a cláusula penal."

respostaRapida: "O consorciado que desiste não recebe as parcelas de volta na data da desistência. Pelo Tema Repetitivo 312 do Superior Tribunal de Justiça, fixado no REsp 1.119.300/RS, julgado pela Segunda Seção em 14 de abril de 2010, 'é devida a restituição de valores vertidos por consorciado desistente ao grupo de consórcio, mas não de imediato, e sim em até trinta dias a contar do prazo previsto contratualmente para o encerramento do plano'. O valor também não é a soma nominal do que foi pago: o artigo 30 da Lei 11.795/2008 determina que a restituição da importância paga ao fundo comum seja calculada com base no percentual amortizado do valor do bem ou serviço vigente na data da assembleia de contemplação, acrescida dos rendimentos da aplicação financeira. Pelo artigo 32 da mesma lei, o encerramento do grupo deve ocorrer em até 120 dias contados da última assembleia de contemplação, e o parágrafo 2º fixa em cinco anos a prescrição da pretensão do consorciado contra a administradora."

keywords:
  - desisti do consórcio
  - devolução de consórcio
  - restituição consórcio desistente
  - quando recebo o dinheiro do consórcio
  - taxa de administração consórcio
  - Tema 312 STJ consórcio
  - cancelar consórcio dinheiro de volta
...
<aside class="callout">
<p><strong>As duas expectativas que a lei contraria.</strong> A primeira é o <em>quando</em>: a restituição não ocorre na desistência, e sim vinculada ao encerramento do grupo. A segunda é o <em>quanto</em>: o valor não é a soma nominal das parcelas pagas, e sim um percentual do valor do bem apurado na forma do artigo 30 da Lei 11.795/2008.</p>
</aside>
...
<aside class="callout">
<p><strong>Um detalhe pouco conhecido, e útil para quem tem financiamento.</strong> O artigo 22, parágrafo 3º, da Lei 11.795/2008 permite que o consorciado contemplado destine o crédito para a <strong>quitação total de financiamento de sua titularidade</strong> — sujeita à prévia anuência da administradora e às condições do contrato. Não é automático, mas está previsto em lei.</p>
</aside>
...
![Relógio de mostrador liso com ponteiros visíveis, sem numerais, sobre fundo escuro](/img/blog/comum/relogio-prazo.webp "O marco do prazo não é a sua saída — é o encerramento do grupo. É a diferença entre esperar meses e esperar anos.")
...
<aside class="callout">
<p><strong>Por que o percentual muda tudo.</strong> Como o cálculo é vinculado ao valor <em>atual</em> do bem, o resultado depende de como o preço do bem se comportou desde a adesão. Se o bem valorizou, o percentual amortizado corresponde a um número maior de reais do que a soma paga. Se desvalorizou, corresponde a menos. É a mesma lógica que reajusta a parcela durante o plano — e ela continua valendo na saída.</p>
</aside>
...
<aside class="callout">
<p><strong>O erro que sai mais caro.</strong> Parar de pagar sem formalizar nada, na expectativa de que "o contrato se resolve sozinho". Ele não se resolve: os encargos correm, e a apuração posterior parte de uma base pior do que partiria se a saída tivesse sido formalizada. Se a decisão é sair, o passo é comunicar por escrito e guardar o protocolo.</p>
</aside>
...
<aside class="callout">
<p><strong>Como ler esta seção.</strong> Taxa de administração e cláusula penal não são tratadas por tese repetitiva vinculante como a do Tema 312. São matérias decididas caso a caso, a partir do contrato concreto e das circunstâncias. Qualquer conteúdo que apresente um resultado como garantido nesses dois pontos está prometendo o que não pode prometer.</p>
</aside>
...
| **Saída antecipada** | Restituição vinculada ao encerramento do grupo (Tema 312) | [Quitação antecipada com redução proporcional dos juros](/blog/quitacao-antecipada-financiamento-desconto-juros) |
...
![Balança de dois pratos em alturas diferentes, fundo quase preto](/img/blog/comum/balanca-comparacao.webp "A escolha não se decide pelo custo isolado, e sim pelo cruzamento entre custo total e o momento em que o bem é necessário.")
