...
metaDescription: "Depois da apreensão, o credor vende o veículo — sem leilão e sem avaliação prévia. Entenda a prestação de contas e por que a dívida pode continuar."

resumo: "Perder o veículo não encerra necessariamente a dívida. O credor vende o bem — e, ao contrário do que quase todo mundo imagina, sem leilão e sem avaliação prévia obrigatórios. Este guia explica o que a lei determina sobre a venda, a prestação de contas e o saldo que pode continuar sendo cobrado."

respostaRapida: "Consolidada a propriedade após a busca e apreensão, o artigo 2º do Decreto-Lei 911/69 autoriza o credor a vender o veículo a terceiros independentemente de leilão, hasta pública ou avaliação prévia, salvo previsão contratual em contrário. O preço obtido deve ser aplicado no pagamento do crédito e das despesas, e o credor é obrigado a entregar ao devedor o saldo apurado, se houver, com a devida prestação de contas. Quando a venda não cobre a dívida, o saldo remanescente continua exigível — razão pela qual é possível perder o bem e permanecer devendo."

keywords:
  - perdi o carro e ainda devo
  - saldo devedor após busca e apreensão
  - leilão de veículo apreendido
  - venda do veículo alienação fiduciária
  - prestação de contas busca e apreensão
  - saldo remanescente financiamento
...
imagem: /img/blog/veiculo-apreendido-vendido-saldo-devedor-remanescente/capa.webp
imagemAlt: "Documento de cobrança sobre mesa escura com uma chave de veículo ao lado, iluminados por luz vermelha rasante"
...
faq:
  - pergunta: "O veículo apreendido vai obrigatoriamente a leilão?"
    resposta: "Não. O artigo 2º do Decreto-Lei 911/69, com a redação dada pela Lei 13.043/2014, autoriza o credor a vender a coisa a terceiros independentemente de leilão, hasta pública, avaliação prévia ou qualquer outra medida judicial ou extrajudicial — salvo disposição expressa em contrário prevista no contrato. A palavra 'leilão' é de uso corrente, mas não descreve uma exigência legal."
  - pergunta: "Como posso saber por quanto o veículo foi vendido?"
    resposta: "O mesmo artigo 2º obriga o credor a entregar ao devedor o saldo apurado, se houver, com a devida prestação de contas. A prestação de contas é obrigação legal, não liberalidade — é por meio dela que se conhece o valor da venda, as despesas deduzidas e a composição do saldo."
  - pergunta: "Se o carro valia mais do que a dívida, tenho direito a receber a diferença?"
    resposta: "Sim. A lei determina que o preço da venda seja aplicado no pagamento do crédito e das despesas decorrentes, e que o saldo apurado, havendo, seja entregue ao devedor. Essa devolução é obrigação do credor e frequentemente não ocorre de forma espontânea."
  - pergunta: "E se a venda não cobrir toda a dívida?"
    resposta: "O saldo remanescente continua exigível, e a cobrança pode prosseguir pelos meios ordinários, inclusive com negativação. É exatamente por isso que existe a situação de perder o veículo e continuar devendo — algo que surpreende a maioria das pessoas."
  - pergunta: "Posso questionar o valor pelo qual o veículo foi vendido?"
    resposta: "A dispensa de avaliação prévia não significa que o credor possa vender por qualquer valor sem consequência. A obrigação de prestar contas e o dever de boa-fé permitem discutir uma alienação por preço muito descolado do valor de mercado do bem, sobretudo quando isso amplia artificialmente o saldo cobrado do devedor. Cada caso depende de demonstração concreta."
  - pergunta: "O que entra nas despesas deduzidas do valor da venda?"
    resposta: "O crédito abrange o principal, juros e comissões, além de taxas, cláusula penal e correção monetária, quando expressamente convencionados (artigo 2º, parágrafo 1º, do Decreto-Lei 911/69). Somam-se as despesas decorrentes da apreensão, remoção, depósito e da própria venda. A composição desse conjunto é um dos pontos que a prestação de contas precisa esclarecer."
  - pergunta: "As diárias de pátio entram na conta?"
    resposta: "As despesas de remoção e depósito do veículo compõem os custos decorrentes e costumam ser deduzidas do valor da venda. Como correm por dia, o tempo entre a apreensão e a alienação afeta diretamente o saldo final — motivo pelo qual a demora nessa etapa não é neutra para o devedor."
  - pergunta: "A liminar foi revogada, mas o carro já tinha sido vendido. E agora?"
    resposta: "Quando a restituição em espécie se torna impossível porque o bem já foi alienado, o STJ entende que ela se converte em ressarcimento, com o valor apurado pela Tabela FIPE. Por isso o registro do estado de conservação e do valor do veículo no momento da apreensão tem relevância prática."
  ...
  - pergunta: "Faz sentido discutir o contrato depois de já ter perdido o veículo?"
    resposta: "Pode fazer. O saldo remanescente é calculado a partir das mesmas cláusulas que regeram o contrato inteiro. Se havia cobrança irregular ao longo da relação, ela se reflete no valor que continua sendo cobrado depois da venda — e a discussão passa a ser sobre esse valor."

fontes:
  - titulo: "Decreto-Lei 911/1969 — artigo 2º, venda do bem e prestação de contas"
    url: "https://www.planalto.gov.br/ccivil_03/decreto-lei/1965-1988/del0911.htm"
    consultadoEm: 2026-08-05
  - titulo: "Lei 13.043/2014 — nova redação do artigo 2º do Decreto-Lei 911/69"
...
<aside class="callout">
<p><strong>Por que isso importa.</strong> Muita gente espera ser convocada para um leilão, acompanhar lances ou receber uma avaliação do veículo. Nada disso é exigência legal. A venda pode simplesmente ocorrer — e o proprietário anterior só toma conhecimento pelo resultado.</p>
</aside>
...
<aside class="callout">
<p><strong>A dispensa de avaliação prévia não é carta branca.</strong> O credor não está obrigado a avaliar o bem antes de vender, mas continua sujeito ao dever de prestar contas e à boa-fé objetiva. Uma alienação por preço muito descolado do valor de mercado, que amplie artificialmente o saldo cobrado do devedor, é discutível — dependendo, como sempre, de demonstração concreta no caso.</p>
</aside>
...
<aside class="callout">
<p><strong>Um ponto que costuma passar batido.</strong> A consolidação da propriedade e a posterior venda geram transferência de registro. Acompanhar se essa transferência foi efetivamente feita evita que infrações e tributos posteriores continuem sendo lançados no nome de quem não tem mais o veículo.</p>
</aside>
...
A GRS Soluções realiza esse tipo de análise em contratos de [financiamento de veículo](/revisao-financiamento-veiculo) e demais [modalidades de crédito](/revisao-emprestimo), apresentando um entendimento técnico do que está sendo cobrado. Quando o caso demanda medida judicial, a condução é feita por advogados parceiros habilitados.
...
Sobre as etapas anteriores desse processo, veja [busca e apreensão de veículo financiado](/blog/busca-e-apreensao-veiculo-financiado-como-funciona/) e [o que acontece quando a parcela atrasa](/blog/atrasei-parcela-financiamento-o-que-acontece/).
