---
titulo: "Atrasei o financiamento da casa: como o imóvel é retomado sem processo judicial — e o que mudou em 2023"
slug: perder-imovel-financiado-leilao-extrajudicial
...
metaDescription: "Intimação no cartório, 15 dias para purgar a mora, consolidação e dois leilões — tudo fora do Judiciário. O rito da Lei 9.514/97 e o que mudou em 2023."

resumo: "No financiamento imobiliário com alienação fiduciária, a retomada do imóvel não passa pelo Judiciário: corre no cartório de registro de imóveis, com prazos curtos e um ponto de não retorno. O STF confirmou a constitucionalidade do procedimento, e a Lei 14.711/2023 alterou regras que quase todo conteúdo sobre o tema ainda repete na versão antiga."

respostaRapida: "Na alienação fiduciária de bem imóvel, regida pela Lei 9.514/1997, a retomada é extrajudicial: vencido o prazo contratual sem pagamento, o devedor é intimado pelo oficial do registro de imóveis e tem 15 dias para purgar a mora. Não purgada, a propriedade é consolidada em nome do credor, mediante prova do pagamento do ITBI e, se for o caso, do laudêmio. Consolidada a propriedade, o credor tem 60 dias — prazo elevado de 30 para 60 pela Lei 14.711/2023 — para promover leilão público. Se o primeiro leilão não alcançar o valor do imóvel, faz-se um segundo em 15 dias. Da averbação da consolidação até a data do segundo leilão, o devedor tem direito de preferência para readquirir o imóvel pelo valor da dívida somado às despesas e encargos. O STF declarou o procedimento constitucional no Tema 982 (RE 860.631). Atenção: a regra que previa expressamente a extinção da dívida quando o segundo leilão era frustrado foi alterada pela Lei 14.711/2023, que também revogou o parágrafo que obrigava o credor a dar quitação."

keywords:
  - perder imóvel financiado
  - leilão extrajudicial imóvel
  - atrasei o financiamento da casa
  - consolidação da propriedade Lei 9.514
  - purgar a mora imóvel 15 dias
  - direito de preferência devedor leilão
  - execução extrajudicial imóvel STF
...
fontes:
  ...
  - titulo: "TJMG — Tema 982 do STF: constitucionalidade do procedimento de execução extrajudicial"
    ...
    consultadoEm: 2026-08-10
  - titulo: "STJ — Consolidada a propriedade em nome do credor, não é possível a purgação da mora"
    url: "https://www.stj.jus.br/sites/portalp/Paginas/Comunicacao/Noticias/2023/11052023-Para-a-Terceira-Turma--consolidada-a-propriedade-em-nome-do-credor--nao-e-possivel-a-purgacao-da-mora.aspx"
    consultadoEm: 2026-08-10
  - titulo: "Migalhas — Consolidação da propriedade, leilão extrajudicial e intimação pessoal do devedor"
    url: "https://www.migalhas.com.br/depeso/431802/consolidacao-da-propriedade-leilao-extrajudicial-e-intimacao-pessoal"
    consultadoEm: 2026-08-10
---
...
<aside class="callout">
<p><strong>Antes de tudo, uma verificação.</strong> Nem todo financiamento imobiliário é alienação fiduciária. Contratos mais antigos podem ter sido celebrados sob hipoteca, cujo rito é judicial e bem mais lento. O que define o procedimento aplicável é a garantia constituída no contrato e registrada na matrícula do imóvel — não o nome comercial do produto nem o banco com quem se contratou.</p>
</aside>
...
![Relógio de mostrador liso, com ponteiros visíveis e sem numerais, sobre mesa escura](/img/blog/comum/relogio-prazo.webp "Quinze dias é o prazo mais curto e mais decisivo de todo o procedimento. É a única janela em que o contrato volta ao normal.")
...
![Balança de dois pratos em alturas diferentes, fundo quase preto, luz vermelha nas bordas](/img/blog/comum/balanca-comparacao.webp "Purgar a mora e exercer a preferência resolvem o mesmo problema por preços muito diferentes. O que separa os dois é o registro da consolidação.")
...
<aside class="callout">
<p><strong>Por que o prazo real é maior do que parece — e menor do que se imagina.</strong> Entre a intimação e a desocupação existe um percurso: 15 dias para purgar, o registro da consolidação, até 60 dias para o leilão, eventual segundo leilão em 15 dias, e então a ação com prazo de 60 dias para desocupar. Somado, é um período de meses — não de dias. Mas cada etapa exige uma reação diferente, e a mais barata de todas, de longe, é a primeira.</p>
</aside>
...
<aside class="callout">
<p><strong>O que se pode e o que não se pode afirmar hoje.</strong> Pode-se afirmar que a regra expressa de extinção automática da dívida <strong>não consta mais</strong> do texto legal, e que o dispositivo que obrigava o credor a dar quitação foi revogado. Não se pode afirmar, como se fosse questão pacificada, que passou a existir saldo remanescente cobrável em toda hipótese — o tema é objeto de discussão doutrinária e judicial. O que é seguro dizer é que quem hoje repete "no imóvel a dívida sempre se extingue" está apoiado numa redação que não está mais em vigor.</p>
</aside>
...
É esse o trabalho que a GRS Soluções realiza na [revisão de financiamento imobiliário](/revisao-financiamento-imovel) e nas demais modalidades de crédito, apresentando um entendimento técnico do que está sendo cobrado. Quando o caso demanda medida judicial, a condução é feita por advogados parceiros habilitados.
