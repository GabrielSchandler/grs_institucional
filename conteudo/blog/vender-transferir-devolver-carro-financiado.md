---
titulo: "Vender, transferir ou devolver um carro financiado: as saídas que existem e a que mais dá problema"
slug: vender-transferir-devolver-carro-financiado
...
metaDescription: "Quitar com a venda, transferir o contrato ou devolver o veículo: o que cada saída exige e por que o contrato de gaveta deixa a dívida no seu nome."

resumo: "Quando a parcela aperta, três caminhos aparecem: vender e quitar, passar o financiamento para outra pessoa, ou devolver o veículo ao banco. Cada um tem exigências próprias, e existe um quarto caminho — o contrato de gaveta — que parece resolver e deixa a dívida, as multas e a busca e apreensão no nome de quem entregou o carro."

respostaRapida: "Um veículo com alienação fiduciária não pode ser vendido ou transferido livremente: enquanto o contrato não é quitado, a propriedade é do credor e o gravame no registro impede a transferência. Existem três saídas regulares. A primeira é vender e usar o valor para quitar o financiamento, o que só funciona se o preço cobrir o saldo devedor. A segunda é a transferência do contrato ao comprador, que depende de consentimento expresso do credor — o artigo 299 do Código Civil determina que o devedor original só é exonerado com esse consentimento, e o parágrafo único interpreta o silêncio do credor como recusa. A terceira é a entrega do veículo ao credor, que não extingue a dívida por si só: se a venda do bem não cobrir o débito, o saldo remanescente continua exigível. O chamado contrato de gaveta não é uma quarta saída: ele não transfere a dívida, mantém o vendedor solidariamente responsável pelas infrações de trânsito até a comunicação da venda (artigo 134 do Código de Trânsito Brasileiro) e faz a busca e apreensão recair sobre quem assinou o financiamento."

keywords:
  - vender carro financiado
  - transferir financiamento para outra pessoa
  - contrato de gaveta carro financiado
  - passar o carro financiado para alguém
  - devolver o carro para o banco
  - carro alienado pode vender
  - assumir as parcelas do carro
...
imagem: /img/blog/vender-transferir-devolver-carro-financiado/capa.webp
imagemAlt: "Chave de veículo sobre um contrato dobrado, ao lado de um chaveiro vazio, sob luz vermelha rasante"
...
<aside class="callout">
<p><strong>Uma distinção que organiza o resto do texto.</strong> Vender o carro e transferir o financiamento são operações diferentes, com regras diferentes. A primeira envolve a propriedade do bem e o registro no órgão de trânsito. A segunda envolve a dívida e depende da instituição financeira. É perfeitamente possível fazer uma sem a outra — e é exatamente daí que vêm os problemas mais caros.</p>
</aside>
...
Os dois termos aparecem com definições próprias no [glossário do blog](/blog/glossario), e vale a leitura de quem está começando a se informar sobre o assunto agora.
...
<aside class="callout">
<p><strong>É essa defasagem que trava a maioria das vendas.</strong> Quando o valor de mercado do carro fica abaixo do saldo devedor, a venda não se paga sozinha: alguém precisa cobrir a diferença em dinheiro para que o contrato seja quitado. Descobrir isso no meio da negociação, com comprador interessado e prazo combinado, é o que empurra as pessoas para o contrato de gaveta.</p>
</aside>
...
Essa mecânica está detalhada no artigo sobre [o que acontece depois que o veículo é vendido e a dívida continua](/blog/veiculo-apreendido-vendido-saldo-devedor-remanescente), e ela vale tanto para o bem retomado judicialmente quanto, em regra, para o bem entregue de forma amigável.

<aside class="callout">
<p><strong>O ponto que decide essa saída.</strong> Para que a entrega do veículo encerre a obrigação por inteiro, a quitação total precisa estar expressa por escrito no acordo. Sem essa cláusula, o que a entrega resolve é a posse do carro — não a dívida. Aceitar uma entrega "de boca", confiando que o assunto está encerrado, é como o saldo remanescente costuma reaparecer meses depois, já acrescido de encargos e com o nome negativado.</p>
</aside>
...
![Um pequeno papel amassado ao lado de uma pilha espessa de folhas de contrato sobre mesa escura](/img/blog/vender-transferir-devolver-carro-financiado/acordo-particular.webp "O acordo particular obriga quem o assinou. Para a instituição financeira, que não participou dele nem consentiu, o devedor continua sendo exatamente o mesmo.")
...
Quem quita antecipadamente tem direito à **redução proporcional desses juros**, nos termos do artigo 52, parágrafo 2º, do Código de Defesa do Consumidor — assunto tratado em detalhe no artigo sobre [quitação antecipada e o desconto que muita gente deixa de receber](/blog/quitacao-antecipada-financiamento-desconto-juros).
...
<aside class="callout">
<p><strong>A comunicação de venda não resolve o financiamento.</strong> Ela é um ato administrativo perante o órgão de trânsito, com uma finalidade específica: afastar a responsabilidade do antigo proprietário pelas penalidades a partir daquela data. Não transfere a propriedade, não baixa o gravame, não altera o contrato e não retira o nome de ninguém da dívida bancária. São dois universos distintos, e um não conserta o outro.</p>
</aside>
...
![Cadeado de metal escuro com o arco aberto, apoiado sobre uma folha de papel clara](/img/blog/vender-transferir-devolver-carro-financiado/gravame.webp "A baixa do gravame é ato do credor, não do devedor — e é ela, não o pagamento em si, que libera o registro para a transferência.")
...
É esse o trabalho que a GRS Soluções faz na [revisão de financiamento de veículo](/revisao-financiamento-veiculo): examinar o contrato para estabelecer quanto efetivamente é devido, antes que decisões definitivas sejam tomadas com base num número que ninguém conferiu.
