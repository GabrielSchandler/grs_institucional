---
titulo: "Portabilidade de crédito: o que o banco não pode recusar, por que às vezes ela não reduz nada — e o que mudou com o Open Finance em 2026"
slug: portabilidade-de-credito-como-funciona-open-finance
...
metaDescription: "Levar o crédito para outro banco é um direito com regras: prazos, proibição de repasse de custos e limites de valor. O que mudou no Open Finance em 2026."

resumo: "Transferir uma operação de crédito para outra instituição que cobre menos é um direito regulado desde 2013, com prazo de resposta definido e proibição expressa de cobrança de tarifa. Ainda assim, é pouco usado — e, quando usado, nem sempre reduz o que se esperava. Este guia explica as regras, os limites que quase ninguém conhece e o que mudou com a entrada da portabilidade no Open Finance, em fevereiro de 2026."

respostaRapida: "Portabilidade de crédito é, nos termos do artigo 2º, inciso I, da Resolução CMN 5.057/2022, a transferência de operação de crédito ou de arrendamento mercantil financeiro da instituição credora original para a instituição proponente. Essa resolução, de 15 de dezembro de 2022, está em vigor desde 1º de março de 2023 e revogou a Resolução CMN 4.292/2013, que disciplinava a matéria antes. Pelo artigo 3º, a instituição credora deve assegurar a portabilidade quando solicitada pelo devedor, mediante o recebimento de recursos da instituição proponente. O artigo 6º limita o valor e o prazo da nova operação ao saldo devedor e ao prazo remanescente da operação original. O artigo 8º dá à instituição credora original até cinco dias úteis para solicitar a transferência de recursos após receber a requisição. E o artigo 15 é expresso: os custos relacionados à troca de informações e à transferência de recursos entre as instituições não podem ser repassados ao devedor. Desde fevereiro de 2026, a portabilidade também pode ser feita pelo Open Finance, começando pelo crédito pessoal sem garantia, com prazo reduzido a três dias úteis nas solicitações digitais."

keywords:
  - portabilidade de crédito
  - transferir financiamento para outro banco
  - portabilidade de financiamento
  - Resolução CMN 5.057
  - portabilidade open finance 2026
  - reduzir juros do financiamento
  - banco recusou portabilidade
...
imagem: /img/blog/portabilidade-de-credito-como-funciona-open-finance/capa.webp
imagemAlt: "Duas portas escuras lado a lado em parede quase preta, uma entreaberta com luz vermelha saindo pela fresta"

relacionados:
  - quitacao-antecipada-financiamento-desconto-juros
  - superendividamento-minimo-existencial-stf
  - consignado-clt-demissao-verbas-rescisorias-fgts

faq:
  - pergunta: "O que é portabilidade de crédito?"
    resposta: "O artigo 2º, inciso I, da Resolução CMN 5.057/2022 a define como a transferência de operação de crédito ou de arrendamento mercantil financeiro da instituição credora original para a instituição proponente. Não é uma nova dívida somada à antiga nem uma renegociação com o mesmo credor: o saldo devedor é liquidado na instituição original com recursos transferidos pela nova, e o contrato passa a correr com quem ofereceu condições melhores. Atenção à base normativa: a Resolução CMN 5.057/2022 revogou a 4.292/2013, ainda hoje citada como se estivesse em vigor."
  - pergunta: "O banco pode recusar a portabilidade?"
    resposta: "O artigo 3º da Resolução CMN 5.057/2022 determina que a instituição credora assegure a portabilidade quando solicitada pelo devedor, mediante o recebimento de recursos da instituição proponente. Não é uma faculdade da instituição atual. O que ela pode fazer, dentro dos prazos previstos, é apresentar contraproposta ao cliente para mantê-lo — o que é coisa diferente de recusar a portabilidade."
  - pergunta: "Posso ser cobrado por fazer a portabilidade?"
    resposta: "Não. A regulamentação proíbe expressamente a cobrança de tarifas ou custos relacionados à transferência da dívida, tanto pela instituição original quanto pela proponente. Cobrança apresentada como taxa de portabilidade, custo de transferência ou nome equivalente contraria a norma. Isso não se confunde com encargos próprios da nova operação, como tributos incidentes, que seguem a regra da modalidade contratada."
  - pergunta: "Qual o prazo para o banco responder?"
    resposta: "A Resolução CMN 5.057/2022 fixa prazos por etapa, e não um prazo único. Pelo artigo 8º, a instituição credora original tem até cinco dias úteis, contados do recebimento da requisição, para solicitar a transferência de recursos. O artigo 10 prevê dois dias úteis para a confirmação do recebimento ou a indicação de inconsistências, e o artigo 11, outros dois dias úteis para o envio do documento comprobatório. Com a entrada da portabilidade no Open Finance, o prazo do caminho tradicional, de até cinco dias úteis, cai para três dias úteis nas solicitações feitas pelo canal digital — mudança anunciada pelo Banco Central junto com o cronograma iniciado em fevereiro de 2026."
  - pergunta: "A nova operação pode ter valor maior do que a antiga?"
    resposta: "Não na portabilidade. O valor e o prazo da nova operação ficam limitados ao saldo devedor e ao prazo remanescente da operação original. Se a proposta apresentada aumenta o valor tomado ou estende o prazo além do que restava, aquilo não é portabilidade em sentido estrito — é outra operação, com outra lógica de custo, e precisa ser avaliada como tal."
  - pergunta: "O que mudou com o Open Finance em 2026?"
    resposta: "A portabilidade de operações de crédito passou a poder ser realizada por meio do Open Finance, com disponibilidade ao público a partir de fevereiro de 2026, começando pelo crédito pessoal sem garantia e sem consignação. A jornada passa a ser inteiramente digital, pelo aplicativo, e o prazo cai de até cinco para três dias úteis nas solicitações digitais. O cronograma prevê testes para o consignado do setor público federal em agosto de 2026 e lançamento ao público em novembro de 2026, com incorporação gradual das demais modalidades."
  - pergunta: "Por que a portabilidade às vezes não reduz o que eu esperava?"
    resposta: "Por três razões estruturais. A primeira é que ela transfere o saldo devedor atual, e não o valor originalmente financiado — parte relevante dos encargos de um contrato já foi paga nas primeiras parcelas. A segunda é que o prazo remanescente limita o alongamento, que é o principal mecanismo de redução da parcela. A terceira é que a comparação relevante é entre custos efetivos totais, e não entre taxas nominais: uma taxa menor com encargos diferentes pode não produzir economia. Vale comparar o CET das duas operações, e não apenas a taxa anunciada."
  - pergunta: "Portabilidade é a mesma coisa que refinanciamento?"
    resposta: "Não. Na portabilidade a dívida é transferida para outra instituição, limitada ao saldo devedor e ao prazo remanescente. No refinanciamento, contrata-se uma operação nova, frequentemente de valor superior ao saldo, com liberação de troco e prazo estendido. São produtos diferentes, e são frequentemente oferecidos com o mesmo vocabulário. Ler qual das duas coisas está na proposta é o passo que evita a confusão mais cara desse assunto."
  - pergunta: "Quem está com as dívidas comprometendo a renda pode fazer portabilidade?"
    resposta: "O artigo 5º do Decreto 11.150/2022 estabelece que a preservação do mínimo existencial não impede a concessão de operação de crédito destinada a substituir operações anteriormente contratadas, desde que se preste a melhorar as condições do consumidor. O parágrafo 2º acrescenta que, quando a substituição ocorre em outra instituição financeira, ela se dá exclusivamente por meio da sistemática da portabilidade de crédito regulamentada pelo Conselho Monetário Nacional."

fontes:
  - titulo: "Resolução CMN 5.057, de 15 de dezembro de 2022 — dispõe sobre a portabilidade de operações de crédito e de arrendamento mercantil financeiro (em vigor desde 1º/03/2023; revogou a Resolução CMN 4.292/2013)"
    url: "https://www.lex.com.br/resolucao-bacen-no-5-057-de-15-de-dezembro-de-2022/"
    consultadoEm: 2026-08-13
  - titulo: "ABBC — Resolução CMN nº 5.057: portabilidade de operações de crédito e arrendamento mercantil"
    url: "https://abbc.org.br/resolucao-cmn-n-5-057-portabilidade-de-operacoes-de-credito-e-arrendamento-mercantil/"
    consultadoEm: 2026-08-13
  - titulo: "Agência Brasil — Banco Central lança portabilidade de crédito no open finance (cronograma e prazos)"
    url: "https://agenciabrasil.ebc.com.br/economia/noticia/2025-11/banco-central-lanca-portabilidade-de-credito-no-open-finance"
    consultadoEm: 2026-08-13
  - titulo: "Decreto 11.150/2022 — artigo 5º: substituição de operações e portabilidade no contexto do mínimo existencial"
    url: "https://www.planalto.gov.br/ccivil_03/_ato2019-2022/2022/decreto/d11150.htm"
    consultadoEm: 2026-08-13
  - titulo: "Banco Central — Open Finance no Brasil"
    url: "https://www.bcb.gov.br/estabilidadefinanceira/openfinance"
    consultadoEm: 2026-08-13
  - titulo: "Código de Defesa do Consumidor (Lei 8.078/1990) — artigo 52, dever de informação no fornecimento de crédito"
...
<aside class="callout">
<p><strong>O que a portabilidade é, em uma frase.</strong> A nova instituição paga o seu saldo devedor na instituição atual e passa a ser sua credora, nas condições que ofereceu. Você não recebe dinheiro, não contrata dívida nova e não soma contratos — troca de credor.</p>
</aside>
...
<aside class="callout">
<p><strong>Como verificar.</strong> A norma vigente é a <strong>Resolução CMN 5.057/2022</strong>. O artigo 21 dela dispõe sobre a entrada em vigor em 1º de março de 2023 e revoga as resoluções anteriores sobre portabilidade. Se um texto sobre o assunto cita a 4.292/2013 sem mencionar a revogação, ele foi escrito antes de 2023 ou copiado de quem escreveu.</p>
</aside>
...
<aside class="callout">
<p><strong>Tarifa de portabilidade não existe.</strong> Pelo artigo 15 da Resolução CMN 5.057/2022, os custos da troca de informações e da transferência de recursos entre as instituições não podem ser repassados ao devedor. Cobrança apresentada como taxa de portabilidade, custo de transferência ou nome equivalente contraria a norma. Isso não se confunde com tributos incidentes sobre a nova operação, que seguem a regra da modalidade contratada.</p>
</aside>
...
<aside class="callout">
<p><strong>A pergunta que separa as duas.</strong> Não é "quanto fica a parcela?". É <em>"quanto eu pago no total até o fim, em cada cenário?"</em>. Parcela menor com prazo maior quase sempre significa custo total maior — e é a comparação que raramente é apresentada de forma espontânea.</p>
</aside>
...
![Duas pilhas de moedas de alturas bem diferentes sobre superfície escura](/img/blog/comum/moedas-pilhas.webp "A comparação útil não é entre duas taxas anunciadas, e sim entre dois custos efetivos totais sobre o mesmo saldo e o mesmo prazo.")
...
<aside class="callout">
<p><strong>O que isso significa para o seu contrato hoje.</strong> Se a sua operação é de <strong>crédito pessoal sem garantia</strong>, a jornada digital já está disponível. Se é <strong>consignado do setor público federal</strong>, o lançamento ao público está previsto para novembro de 2026. Para <strong>financiamento de veículo, imobiliário e consignado privado</strong>, a portabilidade continua existindo pela via tradicional da Resolução CMN 5.057/2022 — o que mudou ainda não alcança todas as modalidades.</p>
</aside>
...
<aside class="callout">
<p><strong>Um item que costuma escapar.</strong> Se a operação original tem <a href="/blog/seguro-prestamista-financiamento-cobertura-recusa">seguro prestamista</a> vinculado, ele acompanha aquela operação — e a liquidação antecipada dela abre a questão da devolução proporcional do prêmio referente ao período não decorrido. Vale perguntar antes de migrar, porque depois a conversa fica com duas instituições em vez de uma.</p>
</aside>
...
| **[Quitação antecipada](/blog/quitacao-antecipada-financiamento-desconto-juros)** | Pagamento do saldo com redução proporcional dos juros | Extingue | Encerra | Você solicita |
...
- Se há **seguro prestamista** vinculado e o que acontece com ele na migração — assunto tratado em [o seguro que veio junto com o financiamento](/blog/seguro-prestamista-financiamento-cobertura-recusa).
...
<aside class="callout">
<p><strong>Peça tudo por escrito.</strong> Contraproposta apresentada por telefone não permite comparação e não deixa registro. O artigo 52 do Código de Defesa do Consumidor impõe ao fornecedor de crédito o dever de informar previamente, entre outros itens, o montante dos juros e o acréscimo legalmente previsto — informação que precisa estar disponível de forma verificável, não apenas verbalizada.</p>
</aside>

![Lupa de aro escuro sobre folha em branco, mesa de madeira](/img/blog/comum/lupa-analise.webp "Saldo, prazo e CET aparecem na proposta. Se o que foi cobrado dentro do contrato atual está correto é outra pergunta — e ela não se responde comparando ofertas.")
