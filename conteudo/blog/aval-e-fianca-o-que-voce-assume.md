---
titulo: "Aval e fiança: a diferença que só aparece quando o devedor para de pagar"
slug: aval-e-fianca-o-que-voce-assume
...
metaDescription: "Avalista e fiador não respondem da mesma forma. Benefício de ordem, exoneração e a Súmula 332 do STJ sobre fiança sem autorização do cônjuge."

resumo: "Assinar como avalista ou como fiador parece o mesmo gesto: garantir a dívida de outra pessoa ou de uma empresa. São institutos distintos, com regimes distintos, e a diferença só se revela quando a cobrança chega. Este guia explica o que cada um significa, o que é benefício de ordem, quando é possível se exonerar e por que a autorização do cônjuge decide a eficácia da garantia."

respostaRapida: "Fiança e aval são garantias pessoais distintas. A fiança é contrato regido pelo Código Civil, no qual o fiador se obriga a satisfazer obrigação do devedor caso este não a cumpra; admite o benefício de ordem do artigo 827, pelo qual o fiador demandado pode exigir que primeiro sejam executados os bens do devedor, salvo se houver renunciado a esse benefício ou se obrigado como principal pagador. O aval é garantia própria de títulos de crédito, autônoma em relação à obrigação garantida e solidária, de modo que o avalista responde nos mesmos termos do avalizado, sem benefício de ordem. Quanto à autorização conjugal, o artigo 1.647, inciso III, do Código Civil exige a anuência do cônjuge para prestar fiança, salvo no regime da separação absoluta; e a Súmula 332 do Superior Tribunal de Justiça, em redação vigente desde 5 de março de 2008, dispõe que a fiança prestada sem autorização de um dos cônjuges implica a ineficácia total da garantia."

keywords:
  - diferença entre aval e fiança
  - o que é ser avalista
  - fiador pode perder bens
  - benefício de ordem fiança
  - Súmula 332 STJ fiança cônjuge
  - como sair de um aval
  - assinei como avalista de empresa
...
fontes:
  - titulo: "Código Civil (Lei 10.406/2002) — fiança, artigos 818 a 839; benefício de ordem, artigo 827; renúncia, artigo 828; exoneração, artigo 835"
    url: "https://www.planalto.gov.br/ccivil_03/leis/2002/l10406compilada.htm"
    consultadoEm: 2026-08-20
  - titulo: "Código Civil (Lei 10.406/2002) — artigo 1.647, inciso III: autorização do cônjuge para prestar fiança"
    url: "https://www.planalto.gov.br/ccivil_03/leis/2002/l10406compilada.htm"
    consultadoEm: 2026-08-20
...
<aside class="callout">
<p><strong>O ponto que organiza o texto.</strong> Garantia pessoal significa que <strong>uma pessoa</strong> responde com o próprio patrimônio pela dívida de outra. Não é aval de crédito, não é referência, não é indicação. É assunção de responsabilidade patrimonial — e é exatamente por isso que ela é exigida.</p>
</aside>
...
<aside class="callout">
<p><strong>Vale procurar essa cláusula.</strong> Ela costuma aparecer em uma linha curta, frequentemente na mesma frase que qualifica o garantidor. É a diferença entre "me cobrem depois de tentarem com ele" e "me cobrem agora". Se você assinou como fiador, essa é a primeira coisa a localizar no instrumento.</p>
</aside>
...
<aside class="callout">
<p><strong>Uma diferença que vale registrar.</strong> A exigência do artigo 1.647, III, menciona expressamente a <strong>fiança</strong>. O tratamento do <strong>aval</strong> quanto à outorga conjugal segue discussão própria, ligada à natureza cambiária da garantia e ao regime de bens. É mais um ponto em que tratar os dois institutos como sinônimos leva a conclusão errada.</p>
</aside>

![Duas folhas off-white sobrepostas, separadas por uma linha de luz vermelha](/img/blog/devolucao-em-dobro-cobranca-indevida/capa.webp "Aval e fiança ocupam a mesma linha no contrato e produzem consequências diferentes. A distinção está no instrumento, não no nome usado na conversa.")
...
<aside class="callout">
<p><strong>Checklist de quem está saindo de uma sociedade.</strong> Levantar todas as operações de crédito da empresa em que você figura como avalista ou fiador; solicitar a cada credor a substituição da garantia ou a liberação formal; e obter isso <strong>por escrito</strong>, antes de assinar a alteração societária. Depois da saída, você perde o poder de negociação que tinha enquanto era sócio.</p>
</aside>
...
<aside class="callout">
<p><strong>O que muda conforme a fase.</strong> Antes da execução, ainda há espaço para negociar substituição de garantia, discutir o valor cobrado ou obter a liberação formal. Depois, o campo se estreita para as defesas cabíveis no próprio processo. Por isso a comunicação inicial ao garantidor não deve ser arquivada sem providência — é o momento de maior margem.</p>
</aside>
...
![Pasta de arquivo aberta com folhas em branco e abas divisórias, sobre mesa escura](/img/blog/comum/pasta-documentos.webp "O instrumento em que a assinatura foi lançada é o documento que define tudo. Sem ele, não há como saber sequer qual das duas garantias foi prestada.")
...
<aside class="callout">
<p><strong>Se você é fiador de um aluguel há anos.</strong> Vale localizar o contrato e verificar três coisas: se há prazo determinado, se houve autorização do cônjuge, e se o contrato de locação foi prorrogado ou renovado. As três respostas juntas indicam qual é a sua posição hoje — que pode ser bem diferente da que era na assinatura.</p>
</aside>
...
Se a sua empresa tem operações de [capital de giro](/blog/capital-de-giro-o-que-a-empresa-precisa-saber) ou de [antecipação de recebíveis](/blog/antecipacao-recebiveis-desconto-duplicatas) com aval dos sócios, vale saber exatamente o que foi assinado — de preferência antes de a operação apresentar dificuldade.

E vale registrar, para quem já está sob cobrança: proteções que existem para a pessoa física, como a impenhorabilidade de verbas salariais, seguem valendo para o garantidor — assunto tratado em [o que a lei protege e onde essa proteção cedeu](/blog/podem-bloquear-meu-salario-por-divida).
...
A GRS Soluções analisa contratos de financiamento, empréstimo, consignado e crédito empresarial, apurando o que foi efetivamente cobrado frente ao que foi contratado. A página de [revisão de crédito empresarial](/revisao-credito-empresarial) descreve como esse exame é conduzido.
