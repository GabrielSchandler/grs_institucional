---
titulo: "Promessa que não se cumpre: como reconhecer oferta irreal no mercado de revisão de dívidas"
slug: promessa-irreal-mercado-revisao-dividas
...
metaDescription: "Resultado garantido, tese pronta antes de ver o contrato, cobrança adiantada: os sinais que distinguem análise técnica séria de oferta que não se sustenta."

resumo: "O mercado de revisão de contratos bancários tem empresas sérias e tem quem venda expectativa. Este guia reúne os sinais que distinguem uma coisa da outra — do ponto de vista de quem contrata — e explica o que os órgãos do sistema de Justiça identificaram como marcador real de prática abusiva, que não é o que a maioria imagina."

respostaRapida: "Os sinais mais confiáveis de oferta irreal em revisão de dívidas são: promessa de resultado garantido, tese apresentada antes de qualquer exame do contrato, cobrança adiantada vinculada a promessa de ganho, pedido de senha ou de acesso a benefício, e afirmação de que uma prática é 'sempre ilegal' — como dizer que a Tabela Price seria ilegal por natureza, tese que o STJ não acolhe. Do lado institucional, o diagnóstico ABJ/CNJ de dezembro de 2025 concluiu que os preditores efetivos de litigância abusiva são fraude documental e fracionamento artificial de ações, e não o volume de processos: advocacia de massa é lícita em si. Nenhuma análise séria promete resultado antes de ler o contrato."

keywords:
  - golpe revisão de dívidas
  - revisional é golpe
  - como escolher empresa revisional
  - promessa de resultado garantido
  - litigância predatória
  - cuidado empresa revisão de contrato
...
imagem: /img/blog/promessa-irreal-mercado-revisao-dividas/capa.webp
imagemAlt: "Contrato de papel sobre mesa escura com uma caneta pousada perto da linha de assinatura, cortado por uma faixa de luz vermelha"
...
faq:
  - pergunta: "Revisão de contrato bancário é golpe?"
    resposta: "Não. A revisão contratual é instrumento jurídico legítimo, prevista no Código de Defesa do Consumidor e amplamente reconhecida pelos tribunais. O que existe são prestadores que vendem expectativa irreal dentro de um mercado legítimo — situação diferente de a atividade em si ser fraudulenta."
  - pergunta: "Qual é o sinal mais confiável de oferta irreal?"
    resposta: "Promessa de resultado antes do exame do contrato. Nenhuma análise séria consegue afirmar que existe valor a recuperar sem ler o documento, as planilhas e o histórico de pagamentos. Quem promete antes de ver está vendendo expectativa, não análise."
  - pergunta: "Cobrar pela análise é sinal de problema?"
    resposta: "Não necessariamente — trabalho técnico tem custo, e cobrar por ele é legítimo. O que merece atenção é a cobrança adiantada vinculada a uma promessa de ganho, ou honorário apresentado como percentual de um resultado que ainda não foi sequer avaliado."
  - pergunta: "Empresa que entra com muitas ações é sinal de litigância predatória?"
    resposta: "Não por si só. O diagnóstico ABJ/CNJ de dezembro de 2025 concluiu que os preditores efetivos de litigância abusiva são a fraude documental e o fracionamento artificial de ações — dividir artificialmente um caso em várias demandas —, e não o volume de processos ajuizados. Advocacia especializada em demandas de massa é lícita e responde a práticas igualmente massivas do outro lado."
  - pergunta: "O que é fracionamento artificial de ações?"
    resposta: "É dividir o que seria uma única demanda em várias, para multiplicar custas, honorários ou chances de resultado. Diferente de ajuizar muitas ações distintas para clientes distintos, que é atividade normal de escritório especializado."
  - pergunta: "Existe abuso também do lado dos bancos?"
    resposta: "Sim, e o tema tem reconhecimento judicial. O ministro Herman Benjamin, do STJ, empregou o termo 'litigância abusiva reversa' ao julgar o REsp 2.021.665/MS, em março de 2025, reconhecendo práticas abusivas também por parte de instituições financeiras. O debate sobre abuso processual não recai apenas sobre um dos polos."
  - pergunta: "Posso perder o bem ou piorar minha situação ao revisar?"
  ...
  - pergunta: "Devo desconfiar de quem manda parar de pagar?"
    resposta: "Sim, e esse é um dos sinais mais graves. Interromper pagamentos por orientação de terceiro, fora de decisão judicial, transfere todo o risco para o contratante e costuma piorar substancialmente a posição dele."
  - pergunta: "É normal pedirem minha senha do Meu INSS ou do banco?"
    resposta: "Não. Senha e acesso a canais oficiais são pessoais e intransferíveis. Documentos podem ser solicitados — contrato, extratos, comprovantes —, mas entrega de senha não é requisito de nenhuma análise legítima e é padrão recorrente em fraudes."
  - pergunta: "Como a GRS trabalha, na prática?"
    resposta: "A GRS Soluções faz análise técnica de contratos: examina o documento, as planilhas e o histórico para identificar o que está sendo cobrado, e apresenta esse entendimento antes de qualquer decisão do cliente. Quando o caso demanda medida judicial, a condução é feita por advogados parceiros habilitados. Não há promessa de resultado, porque resultado depende do que o contrato específico revela."
  - pergunta: "Onde posso verificar ou denunciar uma prática suspeita?"
    resposta: "Reclamações sobre instituições financeiras podem ser registradas no Banco Central e no Procon. Condutas de advogados são apuradas pela seccional da OAB do respectivo estado. Situações envolvendo benefícios do INSS podem ser tratadas pelos canais do próprio INSS e pela Ouvidoria."

fontes:
  - titulo: "CNJ — Rede de Informações sobre a Litigância Abusiva"
    url: "https://www.cnj.jus.br/programas-e-acoes/litigancia-predatoria/"
  ...
  - titulo: "Código de Defesa do Consumidor (Lei 8.078/1990) — publicidade enganosa e práticas abusivas"
    ...
    consultadoEm: 2026-08-05
  - titulo: "Banco Central — Registro de Denúncias e Reclamações"
    url: "https://www.bcb.gov.br/meubc/faqs/p/como-registrar-reclamacao-contra-instituicao-financeira"
    consultadoEm: 2026-08-05
---
...
<aside class="callout">
<p><strong>Teste simples.</strong> Pergunte: "o que exatamente você vai analisar no meu contrato?" Uma resposta séria descreve documentos e verificações. Uma resposta vaga, que devolve promessa em vez de método, já responde.</p>
</aside>
...
A tese de que a Tabela Price seria ilegal por natureza, por exemplo, **não é sustentada pelo STJ**, que entende que a simples adoção do sistema não implica capitalização de juros. O tema está detalhado em [SAC ou Price no financiamento imobiliário](/blog/sac-ou-price-financiamento-imobiliario/).
...
Interromper pagamentos fora de decisão judicial expõe o contratante a encargos de mora, negativação e — em contratos com alienação fiduciária — a [busca e apreensão do bem](/blog/busca-e-apreensao-veiculo-financiado-como-funciona/). A revisão discute o valor da obrigação; ela não suspende a obrigação.
...
Documentos, sim: contrato, extratos, comprovantes, demonstrativos. Senha, não. Esse pedido é padrão recorrente em fraude, especialmente contra beneficiários do INSS — público tratado em [descontos não reconhecidos no benefício](/blog/desconto-nao-reconhecido-beneficio-inss/).
...
<aside class="callout">
<p><strong>O outro polo também é examinado.</strong> O ministro Herman Benjamin, do STJ, empregou o termo <em>"litigância abusiva reversa"</em> ao julgar o REsp 2.021.665/MS, em março de 2025, reconhecendo práticas abusivas também por parte de instituições financeiras. O debate sobre abuso processual não recai sobre um lado só.</p>
</aside>
