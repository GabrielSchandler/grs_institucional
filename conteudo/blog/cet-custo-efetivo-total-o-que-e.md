---
titulo: "CET: o número que diz quanto o crédito realmente custa — e por que ele é sempre maior que a taxa oferecida"
slug: cet-custo-efetivo-total-o-que-e
...
metaDescription: "O CET reúne juros, tributos, tarifas e seguros numa taxa só. É obrigatório informá-lo antes da contratação — e ele é sempre maior que a taxa de juros."

resumo: "Quase toda negociação de crédito gira em torno de dois números: a taxa de juros e o valor da parcela. Existe um terceiro, obrigatório por norma do Conselho Monetário Nacional, que diz o que os outros dois escondem — o Custo Efetivo Total. Este guia explica o que ele reúne, quem tem direito de recebê-lo antes de assinar, e por que comparar sua taxa com a média do Banco Central não responde, sozinho, se você está pagando demais."

respostaRapida: "O Custo Efetivo Total, ou CET, é a taxa que representa de forma consolidada todos os encargos e despesas de uma operação de crédito ou de arrendamento mercantil financeiro, expressa em percentual anual. Ele reúne a taxa de juros do contrato mais tributos, tarifas, seguros e demais despesas cobradas do cliente — por isso é sempre igual ou maior que a taxa de juros isolada, nunca menor. A regra vigente é a Resolução CMN 4.881, de 23 de dezembro de 2020, em vigor desde 1º de fevereiro de 2021, que revogou a Resolução 3.517/2007 e outras normas anteriores sobre o tema. Ela obriga a informar o CET previamente à contratação e alcança operações com pessoas naturais, inclusive empresários individuais, e com pessoas jurídicas classificadas como microempresas e empresas de pequeno porte. O artigo 52 do Código de Defesa do Consumidor impõe dever equivalente de informação prévia no fornecimento de crédito ao consumidor."

keywords:
  - o que é CET
  - custo efetivo total
  - CET e taxa de juros diferença
  - CET do financiamento
  - Resolução CMN 4.881
  - taxa média Banco Central financiamento
  - estou pagando juros demais
...
imagem: /img/blog/cet-custo-efetivo-total-o-que-e/capa.webp
imagemAlt: "Prisma de vidro sobre mesa de madeira escura decompondo um feixe estreito de luz vermelha em várias linhas"
...
faq:
  ...
  - pergunta: "Um CET alto significa que o contrato tem irregularidade?"
    resposta: "Não. CET alto significa custo alto, o que pode decorrer de risco, prazo, garantia ou perfil da operação, tudo perfeitamente lícito. O que o CET permite é comparar e perguntar: se ele está muito acima do praticado em operações semelhantes, vale entender de onde vem a diferença — qual parcela é juro, qual é tarifa, qual é seguro. Essa decomposição é exame técnico do contrato, e não uma leitura do número isolado."

fontes:
  - titulo: "Resolução CMN 4.881, de 23 de dezembro de 2020 — cálculo e informação do Custo Efetivo Total (em vigor desde 01/02/2021; revogou a Resolução 3.517/2007)"
    url: "https://www.bcb.gov.br/content/estabilidadefinanceira/especialnor/Resolu%C3%A7%C3%A3o4881.pdf"
    consultadoEm: 2026-08-21
...
<aside class="callout">
<p><strong>A definição, em uma frase.</strong> O CET é a taxa que reúne, num número só, tudo o que a operação custa: juros, tributos, tarifas, seguros e demais despesas. Por isso ele é <strong>sempre igual ou maior</strong> que a taxa de juros — nunca menor.</p>
</aside>
...
<aside class="callout">
<p><strong>Onde a diferença costuma nascer.</strong> Dois pontos concentram a maior parte do espaço entre taxa e CET: o <strong>seguro vinculado</strong> à operação e as <strong>tarifas financiadas junto com o principal</strong>. Quando uma tarifa é embutida no valor financiado, ela não só é cobrada — ela passa a render juros durante todo o contrato.</p>
</aside>
...
A inclusão de ME e EPP é relevante porque a discussão sobre CET quase sempre é apresentada como assunto de pessoa física. Quem contrata [capital de giro](/blog/capital-de-giro-o-que-a-empresa-precisa-saber) ou [antecipação de recebíveis](/blog/antecipacao-recebiveis-desconto-duplicatas) como pequena empresa tem o mesmo direito à informação prévia e raramente sabe disso.
...
<aside class="callout">
<p><strong>"Previamente" quer dizer antes.</strong> O dever é de informação <em>prévia à contratação</em> — não de constar em algum campo do contrato que se lê depois de assinado. É uma distinção que muda a natureza da obrigação: ela existe para permitir <em>escolha</em>, não para documentar o que já foi decidido.</p>
</aside>
...
![Duas pilhas de moedas de alturas bem diferentes sobre superfície escura](/img/blog/comum/moedas-pilhas.webp "Duas propostas com a mesma taxa de juros podem ter custos bem diferentes. É essa distância que o CET torna visível.")
...
<aside class="callout">
<p><strong>A pergunta que essa conta sugere.</strong> Não é "minha taxa é alta?". É <em>"quanto foi financiado e quanto efetivamente entrou na minha conta?"</em>. Quando os dois números divergem, a diferença está em encargos que passaram a render juros — e é exatamente isso que o CET existe para tornar visível antes da assinatura.</p>
</aside>
...
<aside class="callout">
<p><strong>A formulação correta.</strong> A taxa média do Banco Central é um <strong>parâmetro de comparação</strong>, útil para dimensionar quanto uma operação destoa do praticado no mercado. Ela não determina, sozinha, que um contrato seja abusivo — e cada contrato precisa ser avaliado individualmente. Conteúdo que promete o contrário está simplificando algo que os próprios tribunais ainda estão delimitando.</p>
</aside>
...
- Se há **seguro vinculado** e qual o prêmio — assunto tratado em [o seguro que veio junto com o financiamento](/blog/seguro-prestamista-financiamento-cobertura-recusa).
- Quais **tarifas** foram cobradas e se elas foram pagas à vista ou financiadas junto com o principal.
...
**Na portabilidade.** A comparação que decide se vale migrar não é entre as taxas anunciadas, e sim entre os custos efetivos totais das duas operações, sobre o mesmo saldo e o mesmo prazo. É o que está detalhado em [portabilidade de crédito](/blog/portabilidade-de-credito-como-funciona-open-finance).

**Na quitação antecipada.** O direito à redução proporcional dos juros existe e é obrigatório. Conhecer a composição do custo é o que permite entender o que deve sair da conta — tema de [quitação antecipada](/blog/quitacao-antecipada-financiamento-desconto-juros).
