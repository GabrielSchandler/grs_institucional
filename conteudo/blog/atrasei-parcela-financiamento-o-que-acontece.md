...
metaDescription: "Multa, juros de mora, negativação e retomada do bem: o que a lei prevê a cada estágio do atraso de um financiamento — e por que a régua de 30, 60 e 90 dias não existe."

resumo: "Multa de até 2%, juros de mora, negativação e, mais adiante, a retomada do bem. Este guia explica o que a lei prevê em cada estágio do atraso, o que é apenas prática comercial do banco, e por que a régua de 30, 60 e 90 dias que circula na internet não está escrita em lugar nenhum."

respostaRapida: "O atraso de uma parcela de financiamento gera multa de no máximo 2% sobre o valor da prestação (artigo 52, parágrafo 1º, do Código de Defesa do Consumidor), juros de mora e correção, conforme o contrato. A negativação em cadastro de inadimplentes exige notificação prévia do órgão que mantém o cadastro (Súmula 359 do STJ) e a informação negativa não pode constar por mais de cinco anos. Não existe número mínimo de parcelas em atraso definido em lei para o credor retomar o bem: o requisito é a mora comprovada. Os prazos de 30, 60 e 90 dias que circulam na internet são prática comercial, não regra jurídica."

keywords:
  - atrasei a parcela do financiamento
  - parcela do carro atrasada
  - o que acontece se atrasar o financiamento
  - juros de mora financiamento
  - multa por atraso parcela
  - negativação financiamento
  - quantas parcelas atrasadas para perder o carro
...
imagem: /img/blog/atrasei-parcela-financiamento-o-que-acontece/capa.webp
imagemAlt: "Calendário de mesa em ambiente escuro com uma data marcada em vermelho, sugerindo um vencimento perdido"
...
faq:
  ...
  - pergunta: "Posso perder o carro por causa de uma única parcela em atraso?"
    resposta: "Juridicamente, o que autoriza o pedido de busca e apreensão é a mora comprovada, e a mora decorre do simples vencimento do prazo. Na prática, iniciar o procedimento por uma única parcela é incomum, porque o custo do processo não compensa para o credor — mas não há impedimento legal que dependa de quantidade."
  - pergunta: "Renegociar com o banco resolve?"
    resposta: "Pode resolver o problema imediato do atraso, mas o efeito de longo prazo depende das condições. Renegociações que incorporam encargos anteriores ao novo saldo costumam alongar o prazo e elevar o custo total sem que isso fique evidente na proposta. A comparação relevante não é entre a parcela antiga e a nova, e sim entre o total que se pagaria em cada cenário."
  - pergunta: "O atraso impede a revisão do contrato?"
...
fontes:
  ...
  - titulo: "STJ — Súmula 472: comissão de permanência e a exigibilidade de outros encargos"
    ...
    consultadoEm: 2026-08-05
  - titulo: "TJDFT — Impossibilidade de cobrança de comissão de permanência cumulada com outros encargos"
    url: "https://www.tjdft.jus.br/consultas/jurisprudencia/jurisprudencia-em-temas/jurisprudencia-em-detalhes/acao-revisional-de-contrato-bancario/impossibilidade-de-cobranca-de-comissao-de-permanencia-cumulada-com-outros-encargos-moratorios-remuneratorios"
    consultadoEm: 2026-08-05
...
<aside class="callout">
<p><strong>Antes de tudo, um esclarecimento.</strong> Circula muito na internet uma régua de "30, 60 e 90 dias" descrevendo o que aconteceria em cada faixa de atraso. Ela não está escrita em lei nenhuma. É uma média observada do comportamento do mercado, e varia bastante entre instituições. Tratá-la como regra dá uma falsa sensação de prazo garantido.</p>
</aside>
...
<aside class="callout">
<p><strong>Endereço desatualizado é risco concreto.</strong> O STJ firmou, em recurso repetitivo, que basta o envio da notificação ao endereço indicado pelo devedor no contrato — não é necessário que ela tenha sido recebida pessoalmente. Quem mudou de casa e não atualizou o cadastro tende a ser considerado validamente notificado por uma carta entregue no endereço antigo.</p>
</aside>
...
A GRS Soluções faz essa análise em contratos de [financiamento de veículo](/revisao-financiamento-veiculo), [financiamento imobiliário](/revisao-financiamento-imovel), [empréstimo e crédito](/revisao-emprestimo) e [crédito empresarial](/revisao-credito-empresarial), apresentando um entendimento técnico do que está sendo cobrado antes de qualquer decisão. Quando o caso demanda medida judicial, a condução é feita por advogados parceiros habilitados.
